<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $query = "INSERT INTO usuarios (correo, password) VALUES ('$correo', '$hash')";
        $result = mysqli_query($conn, $query);
    }
    //Eliminar usuarios
    if(isset($_POST['eliminar'])){
        foreach ($_POST['idUsuario'] as $idUsuario) {
    ...
    <div class="container mx-auto p-10">
        ...
        <form action="" method="post" class="mb-6">
            <div class="mb-6">
                ...
                <input type="email" name="correo" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" required="">
            </div>
            <div class="mb-6">
                <label for="contraseña" class="block mb-2 text-sm font-medium text-psipeGray">Contraseña</label>
                <input type="text" name="password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" required="">
            </div>
                ...
                <?php
                    ...
                    while ($usuario = mysqli_fetch_array($result)){
                        echo '<tr class="bg-gray-100 border-b border-gray-200">';
                            ...
                            echo '<td class="px-4 py-5 text-center"><input type="checkbox" name="idUsuario[]" value="'.$usuario['id_usuario'].'"></td>';
                        echo '</tr>';
                    }
                ?>
            </table>
