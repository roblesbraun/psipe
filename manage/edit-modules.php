<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $query = "UPDATE modulos SET nombre = '$nombreModulo', rangoClases = '$rangoClases' WHERE idModulo = $idModulo;";
        $result = mysqli_query($conn, $query);
    }
...
<body>
   <!-- Navbar -->
    ...
    <div class="container mx-auto p-10">
        ...
        <h1 class="text-2xl text-center mb-5">Editar Módulos</h1>
        <!-- FORM -->
        ...
        <form action="" method="post">
            <div class="mb-6">
                <label for="nombreModulo" class="block mb-2 text-sm font-medium text-psipeGray">Nombre del Módulo</label>
                <input type="text" name="nombreModulo" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" placeholder="Material Principal" required="" value="<?php echo $nombreModulo ?>">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="rangoClases" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" placeholder="Material Principal" required="" value="<?php echo $rangoClases ?>">
            </div>
